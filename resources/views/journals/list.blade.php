                        ...
                        <div class="w-full flex flex-col gap-4">
                            ...
                            <div>
                                <textarea x-data="{
                                    ...
                                    name="description"
                                    class="flex w-full h-auto min-h-[100px] px-3 py-2 text-sm bg-white border rounded-md border-neutral-300 ring-offset-background placeholder:text-neutral-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-400 disabled:cursor-not-allowed disabled:opacity-50">{{ old('description') }}</textarea>
                                @error('date')
                                    <span class="text-sm text-red-400">{{ $message }}</span>
                                @enderror
                            </div>
